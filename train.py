...
def parse_args():
    ...
    parser.add_argument("--input", dest="input_path",
                        metavar="I", type=str, default="D:\\Deep Learning\\Traffic Sign\\zaloai\\za_traffic_2020\\traffic_train\\images",
...
def main(args):
    ...
    TFRECORDS_FILE = "D:\\Deep Learning\\Traffic Sign\\zaloai\\za_traffic_2020\\traffic_train\\images\\images.tfrecords"
    metadata = json.load(open("D:\\Deep Learning\\Traffic Sign\\zaloai\\za_traffic_2020\\traffic_train\\train_traffic_sign_dataset.json", "r"))
